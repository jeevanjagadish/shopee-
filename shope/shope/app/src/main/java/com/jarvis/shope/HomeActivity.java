...
import com.jarvis.shope.Model.Data;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data,MyView>adapter=new FirebaseRecyclerAdapter<Data, MyView>
                (
                        Data.class,
                        R.layout.item_data,
                        MyView.class,
        ...
        {
            @Override
            protected void populateViewHolder(MyView viewHolder, final Data model, final int position) {
